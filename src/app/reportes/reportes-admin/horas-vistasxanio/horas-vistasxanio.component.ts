...
@Component({
  selector: 'app-horas-vistasxanio',
  templateUrl: './horas-vistasxanio.component.html',
  styleUrls: ['./horas-vistasxanio.component.css']
})
export class HorasVistasxanioComponent implements OnInit {
  horasVistas: number[];
  fecha: string[];
  emailUsuario: string;
  data:any={};
