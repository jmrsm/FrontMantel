...
@Component({
  selector: 'app-horas-vistasxmes',
  templateUrl: './horas-vistasxmes.component.html',
  styleUrls: ['./horas-vistasxmes.component.css']
})
export class HorasVistasxmesComponent implements OnInit {
  horasVistas: number[];
  fecha: string[];
  emailUsuario: string;
  data:any={};
