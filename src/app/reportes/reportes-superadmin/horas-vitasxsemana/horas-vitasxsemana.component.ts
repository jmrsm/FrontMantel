...
@Component({
  selector: 'app-horas-vitasxsemana',
  templateUrl: './horas-vitasxsemana.component.html',
  styleUrls: ['./horas-vitasxsemana.component.css']
})
export class HorasVitasxsemanaComponent implements OnInit {
  horasVistas: number[];
  fecha: string[];
  data:any={};
