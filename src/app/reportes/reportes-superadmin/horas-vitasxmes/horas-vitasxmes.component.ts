...
@Component({
  selector: 'app-horas-vitasxmes',
  templateUrl: './horas-vitasxmes.component.html',
  styleUrls: ['./horas-vitasxmes.component.css']
})
export class HorasVitasxmesComponent implements OnInit {
  horasVistas: number[];
  fecha: string[];
  data:any={};
